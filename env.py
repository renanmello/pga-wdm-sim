...
def select(population: Population,pop_size: int,
           tourn_size: int = 3) -> Population:
...
def cross(parents: Population, pop_size: int, tc: float) -> Population:
    ...
    #children1 = Population()
    #children2 = Population()
   # while count < 2:


        #children1=Chromosome(son)
        #children2=Chromosome(daughter)
        #count = count + 2
